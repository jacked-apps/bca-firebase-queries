...
__export(src_exports, {
  ...
  useAddPlayerToTeam: () => useAddPlayerToTeam,
  useAddSeason: () => useAddSeason,
  useAddTeamToBothViaPlayer: () => useAddTeamToBothViaPlayer,
  useAddTeamToBothViaUser: () => useAddTeamToBothViaUser,
  useAuth: () => useAuth,
  useFetchCurrentUserById: () => useFetchCurrentUserById,
  useFetchCurrentUsers: () => useFetchCurrentUsers,
  useFetchFinishedRoundRobin: () => useFetchFinishedRoundRobin,
  useFetchPastPlayerById: () => useFetchPastPlayerById,
  useFetchPastPlayers: () => useFetchPastPlayers,
  useFetchRoundRobin: () => useFetchRoundRobin,
  useFetchSeason: () => useFetchSeason,
  useFetchSeasons: () => useFetchSeasons,
  useFetchTeamById: () => useFetchTeamById,
  useFetchTeamsFromSeason: () => useFetchTeamsFromSeason,
  useRemoveTeamFromBothViaPlayer: () => useRemoveTeamFromBothViaPlayer,
  useRemoveTeamFromBothViaUser: () => useRemoveTeamFromBothViaUser,
  useRemoveTeamFromSeason: () => useRemoveTeamFromSeason,
  useUpdateSeason: () => useUpdateSeason,
  useUpdateSeasonSchedule: () => useUpdateSeasonSchedule,
  useUpdateTeamData: () => useUpdateTeamData
});
...
var useFetchSeasons = () => {
  ...
  return __spreadProps(__spreadValues({}, (0, import_react_query.useQuery)("currentSeasons", fetchSeasonsRQ)), { refetchSeasons });
};
var useFetchSeason = (seasonName) => {
  return (0, import_react_query.useQuery)(["season", seasonName], () => fetchSeasonRQ(seasonName));
};
var fetchSeasonsRQ = () => __async(void 0, null, function* () {
  const seasonQuery = (0, import_firestore2.query)(
    (0, import_firestore2.collection)(db, "seasons"),
    (0, import_firestore2.where)("seasonCompleted", "==", false)
  );
  const querySnapshot = yield (0, import_firestore2.getDocs)(seasonQuery);
...
var fetchSeasonRQ = (seasonName) => __async(void 0, null, function* () {
  ...
  const seasonDoc = (0, import_firestore2.doc)(db, "seasons", seasonName);
  const seasonDocSnapshot = yield (0, import_firestore2.getDoc)(seasonDoc);
...
var addSeasonRQ = (_0) => __async(void 0, [_0], function* ({
  ...
  const seasonRef = (0, import_firestore3.doc)(db, "seasons", seasonName);
  yield (0, import_firestore3.setDoc)(seasonRef, __spreadProps(__spreadValues({}, seasonData), { seasonCompleted: false }));
});
var updateSeasonRQ = (_0) => __async(void 0, [_0], function* ({
  ...
  const seasonRef = (0, import_firestore3.doc)(db, "seasons", seasonName);
  yield (0, import_firestore3.updateDoc)(seasonRef, seasonData);
});
...
var fetchRoundRobinRQ = (numberOfTeams) => __async(void 0, null, function* () {
  ...
  const scheduleRef = (0, import_firestore4.doc)(db, "roundRobinSchedules", scheduleName);
  const scheduleDoc = yield (0, import_firestore4.getDoc)(scheduleRef);
...
var fetchFinishedRoundRobinRQ = (seasonId) => __async(void 0, null, function* () {
  ...
  const scheduleRef = (0, import_firestore4.doc)(db, "finishedRoundRobinSchedules", seasonId);
  const scheduleDoc = yield (0, import_firestore4.getDoc)(scheduleRef);
  if (scheduleDoc.exists()) {
    return scheduleDoc.data();
  } else {
...
var useFetchCurrentUserById = (id) => {
  return (0, import_react_query4.useQuery)(["currentUser", id], () => fetchCurrentUserById(id), {
    enabled: !!id
  });
};
var useFetchPastPlayers = () => {
  return (0, import_react_query4.useQuery)("pastPlayers", fetchAllPastPlayersRQ);
};
var useFetchCurrentUsers = () => {
  return (0, import_react_query4.useQuery)("currentUsers", fetchAllCurrentUsersRQ);
};
var fetchPastPlayerByIdRQ = (playerId) => __async(void 0, null, function* () {
  if (playerId === void 0) {
    throw new Error("Player ID not provided");
  }
  const playerDoc = (0, import_firestore5.doc)(db, "pastPlayers", playerId);
  const playerDocSnapshot = yield (0, import_firestore5.getDoc)(playerDoc);
...
var fetchCurrentUserById = (id) => __async(void 0, null, function* () {
  ...
  const userDoc = (0, import_firestore5.doc)(db, "currentUsers", id);
  const userDocSnapshot = yield (0, import_firestore5.getDoc)(userDoc);
...
var fetchAllPastPlayersRQ = () => __async(void 0, null, function* () {
  const querySnapshot = yield (0, import_firestore5.getDocs)((0, import_firestore5.collection)(db, "pastPlayers"));
  const playersData = [];
...
var fetchAllCurrentUsersRQ = () => __async(void 0, null, function* () {
  const querySnapshot = yield (0, import_firestore5.getDocs)((0, import_firestore5.collection)(db, "currentUsers"));
  const usersData = [];
  querySnapshot.forEach((doc9) => {
...
var updateSeasonScheduleRQ = (_0) => __async(void 0, [_0], function* ({
  ...
  const seasonRef = (0, import_firestore6.doc)(db, "seasons", seasonName);
  yield (0, import_firestore6.updateDoc)(seasonRef, {
    schedule
  });
});
...
var useFetchTeamById = (teamId) => {
  return (0, import_react_query6.useQuery)(["team", teamId], () => fetchTeamByIdRQ(teamId), {
...
var fetchTeamByIdRQ = (teamId) => __async(void 0, null, function* () {
  ...
  const teamDoc = (0, import_firestore7.doc)(db, "teams", teamId);
  const teamDocSnapshot = yield (0, import_firestore7.getDoc)(teamDoc);
...
var useAddPlayerToTeam = () => {
  return (0, import_react_query7.useMutation)(addPlayerToTeamRQ, {
    onSuccess: () => {
      console.log("success");
    },
    onError: () => {
...
var useAddTeamToBothViaPlayer = () => {
  return (0, import_react_query7.useMutation)(addTeamToBothWithPlayer, {
    onSuccess: () => {
      console.log("success");
    },
    onError: () => {
...
var useAddTeamToBothViaUser = () => {
  return (0, import_react_query7.useMutation)(addTeamToBothWithUser, {
    onSuccess: () => {
      console.log("success");
    },
    onError: () => {
...
var useRemoveTeamFromBothViaPlayer = () => {
  return (0, import_react_query7.useMutation)(removeTeamFromBothWithPlayer, {
    onSuccess: () => {
      console.log("success");
    },
    onError: () => {
...
var useRemoveTeamFromBothViaUser = () => {
  return (0, import_react_query7.useMutation)(removeTeamFromBothWithUser, {
    onSuccess: () => {
      console.log("success");
    },
    onError: () => {
...
var addTeamToPastPlayer = (teamId, pastPlayerId) => __async(void 0, null, function* () {
  const playerRef = (0, import_firestore8.doc)(db, "pastPlayers", pastPlayerId);
  yield (0, import_firestore8.updateDoc)(playerRef, {
    teams: (0, import_firestore8.arrayUnion)(teamId)
  });
});
var addTeamToCurrentUser = (teamId, currentUserId) => __async(void 0, null, function* () {
  ...
  const userRef = (0, import_firestore8.doc)(db, "currentUsers", currentUserId);
  yield (0, import_firestore8.updateDoc)(userRef, {
    teams: (0, import_firestore8.arrayUnion)(teamId)
  });
});
...
var removeTeamFromPastPlayer = (teamId, pastPlayerId) => __async(void 0, null, function* () {
  ...
  const playerRef = (0, import_firestore8.doc)(db, "pastPlayers", pastPlayerId);
  yield (0, import_firestore8.updateDoc)(playerRef, {
    teams: (0, import_firestore8.arrayRemove)(teamId)
  });
});
...
var insertPlayerOntoTeam = (teamId, role, playerData) => __async(void 0, null, function* () {
  const teamRef = (0, import_firestore8.doc)(db, "teams", teamId);
  const teamDoc = yield (0, import_firestore8.getDoc)(teamRef);
  if (teamDoc.exists()) {
    ...
    yield (0, import_firestore8.updateDoc)(teamRef, newTeamData);
  }
});
var removeAllPlayersFromTeamRQ = (teamId) => __async(void 0, null, function* () {
  yield (0, import_firestore8.runTransaction)(db, (transaction) => __async(void 0, null, function* () {
    const teamRef = (0, import_firestore8.doc)(db, "teams", teamId);
    ...
    for (const pastPlayerId of playerIds) {
      const pastPlayerRef = (0, import_firestore8.doc)(db, "pastPlayers", pastPlayerId);
      ...
      if (pastPlayerData == null ? void 0 : pastPlayerData.currentUserId) {
        const currentUserRef = (0, import_firestore8.doc)(
          db,
          "currentUsers",
...
var updateTeamDataRQ = (_0) => __async(void 0, [_0], function* ({
  ...
  const teamRef = (0, import_firestore9.doc)(db, "teams", teamId);
  yield (0, import_firestore9.updateDoc)(teamRef, data);
});
var deleteTeamRQ = (teamId) => __async(void 0, null, function* () {
  const teamRef = (0, import_firestore9.doc)(db, "teams", teamId);
  yield (0, import_firestore9.deleteDoc)(teamRef);
});
var addNewTeamToSeasonRQ = (_0) => __async(void 0, [_0], function* ({
  seasonName,
  teamName
}) {
  yield (0, import_firestore9.runTransaction)(db, (transaction) => __async(void 0, null, function* () {
    const seasonRef = (0, import_firestore9.doc)(db, "seasons", seasonName);
    const seasonDoc = yield transaction.get(seasonRef);
    if (!seasonDoc.exists()) {
      throw new Error(`Season ${seasonName} not found`);
    }
    const teamRef = (0, import_firestore9.doc)((0, import_firestore9.collection)(db, "teams"));
...
var useAuth = () => {
  ...
  (0, import_react.useEffect)(() => {
    const unsubscribe = (0, import_auth2.onAuthStateChanged)(auth, (currentUser) => {
      setUser(currentUser);
    });
    return () => {
      unsubscribe();
