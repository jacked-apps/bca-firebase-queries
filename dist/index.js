...
var useFetchSeasons = () => {
  ...
  return __spreadProps(
    __spreadValues({}, useQuery('currentSeasons', fetchSeasonsRQ)),
    { refetchSeasons }
  );
};
...
var useAddSeason = () => {
  ...
  const addSeason = (seasonName, seasonData) =>
    __async(void 0, null, function* () {
...
var addSeasonRQ = (_0) =>
  __async(void 0, [_0], function* ({ seasonName, seasonData }) {
    const seasonRef = doc2(db, 'seasons', seasonName);
    yield setDoc(
      seasonRef,
      __spreadProps(__spreadValues({}, seasonData), { seasonCompleted: false })
    );
  });
var updateSeasonRQ = (_0) =>
  __async(void 0, [_0], function* ({ seasonName, seasonData }) {
    const seasonRef = doc2(db, 'seasons', seasonName);
...
var fetchRoundRobinRQ = (numberOfTeams) =>
  __async(void 0, null, function* () {
...
var fetchFinishedRoundRobinRQ = (seasonId) =>
  __async(void 0, null, function* () {
    if (seasonId === void 0) {
...
var fetchPastPlayerByIdRQ = (playerId) =>
  __async(void 0, null, function* () {
    if (playerId === void 0) {
...
var fetchAllPastPlayersRQ = () =>
  __async(void 0, null, function* () {
    ...
    querySnapshot.forEach((doc9) => {
      ...
      playersData.push(
        __spreadProps(__spreadValues({}, playerData), {
          id: doc9.id,
        })
      );
    });
...
var fetchAllCurrentUsersRQ = () =>
  __async(void 0, null, function* () {
    ...
    querySnapshot.forEach((doc9) => {
      ...
      usersData.push(
        __spreadProps(__spreadValues({}, userData), {
          id: doc9.id,
        })
      );
    });
...
var updateSeasonScheduleRQ = (_0) =>
  __async(void 0, [_0], function* ({ seasonName, schedule }) {
...
var addTeamToPastPlayer = (teamId, pastPlayerId) =>
  __async(void 0, null, function* () {
...
var addTeamToCurrentUser = (teamId, currentUserId) =>
  __async(void 0, null, function* () {
...
var addTeamToBothWithPlayer = (teamId, pastPlayerId) =>
  __async(void 0, null, function* () {
...
var addTeamToBothWithUser = (teamId, currentUserId) =>
  __async(void 0, null, function* () {
    if (!teamId || !currentUserId)
      throw new Error('Missing teamId or currentUserId');
...
var removeTeamFromPastPlayer = (teamId, pastPlayerId) =>
  __async(void 0, null, function* () {
    if (!teamId || !pastPlayerId)
      throw new Error('Missing teamId or pastPlayerId');
    const playerRef = doc7(db, 'pastPlayers', pastPlayerId);
...
var removeTeamFromCurrentUser = (teamId, currentUserId) =>
  __async(void 0, null, function* () {
    if (!teamId || !currentUserId)
      throw new Error('Missing teamId or currentUserId');
    const userRef = doc7(db, 'currentUsers', currentUserId);
...
var removeTeamFromBothWithPlayer = (teamId, pastPlayerId) =>
  __async(void 0, null, function* () {
    if (!teamId || !pastPlayerId)
      throw new Error('Missing teamId or pastPlayerId');
...
var removeTeamFromBothWithUser = (teamId, currentUserId) =>
  __async(void 0, null, function* () {
    if (!teamId || !currentUserId)
      throw new Error('Missing teamId or currentUserId');
...
var addPlayerToTeamRQ = (_0) =>
  __async(void 0, [_0], function* ({ teamId, role, playerData }) {
...
var insertPlayerOntoTeam = (teamId, role, playerData) =>
  __async(void 0, null, function* () {
...
var removeAllPlayersFromTeamRQ = (teamId) =>
  __async(void 0, null, function* () {
    yield runTransaction(db, (transaction) =>
      __async(void 0, null, function* () {
        const teamRef = doc7(db, 'teams', teamId);
...
var useRemoveTeamFromSeason = () => {
  ...
  const removeTeam = (seasonName, teamId) =>
    __async(void 0, null, function* () {
      try {
...
var removeTeamFromSeasonRQ = (_0) =>
  __async(void 0, [_0], function* ({ seasonName, teamId }) {
...
var updateTeamDataRQ = (_0) =>
  __async(void 0, [_0], function* ({ teamId, data }) {
    const teamRef = doc8(db, 'teams', teamId);
    yield updateDoc4(teamRef, data);
  });
var deleteTeamRQ = (teamId) =>
  __async(void 0, null, function* () {
    const teamRef = doc8(db, 'teams', teamId);
    yield deleteDoc(teamRef);
  });
var addNewTeamToSeasonRQ = (_0) =>
  __async(void 0, [_0], function* ({ seasonName, teamName }) {
    yield runTransaction2(db, (transaction) =>
      __async(void 0, null, function* () {
