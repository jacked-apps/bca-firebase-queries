...
export type MatchWeek = {
  ...
  [tableNumber: string]: {
    ...
    gamePlay: GamePlay; // Game play includes the game number and the results of the game (breaker, racker, winner)
...
// Represents the entire round-robin schedule with weeks as keys and arrays of table match ups.
